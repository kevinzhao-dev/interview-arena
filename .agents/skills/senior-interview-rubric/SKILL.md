...
description: Use when scoring or debriefing senior SWE coding, system design, or behavioral interview sessions. Applies the active target preset and produces mode-aware feedback, evidence, and next drills.
---
...
Score mock interviews with the rigor defined by the active target preset. The output should help the candidate improve, not merely feel reassured.
...
Do not use formal hire/no-hire labels outside Onsite Mock Mode unless the user explicitly asks for an onsite-style hire signal.
